...
import com.github.denisura.realquacker.ui.authenticator.AuthenticatorActivity;
...
public class AppAuthenticator extends AbstractAccountAuthenticator {
    ...
    public Bundle addAccount(AccountAuthenticatorResponse response, String accountType, String authTokenType,
        ...
        final Intent intent = AuthenticatorActivity.newIntent(mContext, accountType);
    ...
    public Bundle getAuthToken(AccountAuthenticatorResponse response, Account account, String authTokenType,
        ...
        if (TextUtils.isEmpty(authToken)) {
            ...
            if (!TextUtils.isEmpty(password)) {
                //TODO replace with retrofit implementation
